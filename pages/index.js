      ...
      {/* <main className={styles.main} > */}
          {/* <main className="cd-main-content"> */}
            ...
            <div className="center">
                <button className="cd-btn cd-modal-trigger" onClick={(e) => handleOpenClick(e)} variant="contained" color="secondary">
                  Click
                </button>
            </div>
            ...
            {/* <div className={`cd-modal`}> */}
              ...
              <button className="modal-close" onClick={(e) => handleCloseClick(e)} variant="contained" color="secondary">
                  Close
                </button>
            </div>
          ...
          <div className={`cd-transition-layer ${transitionBackgroundClass}`}>
            <div className={`bg-layer `} style={{Width: `${layerWidth*frames}px`, Height: `${layerHeight}px`}}></div>
          </div>
